...
> For help setting up the KSM amd creating an application, head to the [official docs](https://docs.keeper.io/secrets-manager/secrets-manager/quick-start-guide).
